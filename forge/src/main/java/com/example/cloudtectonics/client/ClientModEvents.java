...
@Mod.EventBusSubscriber(modid = com.example.cloudtectonics.CloudTectonicsMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class ClientModEvents {
    ...
    public static void onModifyBakingResult(net.minecraftforge.client.event.ModelEvent.ModifyBakingResult event) {
        ...
        for (net.minecraft.resources.ResourceLocation loc : new java.util.ArrayList<>(models.keySet())) {
            if (loc.getNamespace().equals(com.example.cloudtectonics.CloudTectonicsMod.MOD_ID) && (loc.getPath().equals("building_proxy") || loc.getPath().equals("block/building_proxy"))) {
