...
public class BuildingConfigurationScreen extends Screen {
    ...
    protected void init() {
        ...
        Button toggleDebug = Button.builder(Component.literal("调试功能: " + getToggleLabel(ClientForgeEvents.debugEnabled)), btn -> {
            ClientForgeEvents.debugEnabled = !ClientForgeEvents.debugEnabled;
            btn.setMessage(Component.literal("调试功能: " + getToggleLabel(ClientForgeEvents.debugEnabled)));
            if (!ClientForgeEvents.debugEnabled && com.example.cloudtectonics.math.BuildingDebugLogger.isLogging()) {
